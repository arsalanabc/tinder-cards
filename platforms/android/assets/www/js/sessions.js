var sessions = [
    {id:0 , title:"PhoneGap Developer App and the PhoneGap GUI", speaker:"Tim Kim", pic: "timkim.jpeg", time:"9:00am",
        ...
        description: "Developing for PhoneGap just got easier with the newly released PhoneGap GUI that ties in with the PhoneGap Developer App. Learn how to use both to make your PhoneGap development workflow faster and easier than before."},
    ...
    {id:4 , title:"PhoneGap Enterprise", speaker:"Anis Kadri", pic: "anis.png", time:"10:00am",
        ...
        description:"Learn more about PhoneGap enterprise. A new way to create and distribute apps inside your enterprise powered by Adobe Marketing Cloud and Adobe Experience Manager. Find out how you can speed up your development cycles and allow your team members to better collaborate in order to easily create mobile apps."},
    ...
    {id:5 , title:"Sneak Peek: Adobe Experience Manager and Mobile", speaker:"Anthony Rumsey", pic: "anthony.jpeg", time:"4:45pm",
        ...
        description: "See a sneak peek demo of the new features coming soon to PhoneGap Enterprise and Adobe Experience Manager."},
    ...
    {id:10 , title:"testing", speaker:"HAHAHAH", pic: "holly.jpg", time:"3:00pm",
        room:"Theater", twitter_id: "devgirlsfl",
        description: "In this workshop we’ll build a full-blown mobile application from scratch for a real world scenario using PhoneGap and the Ionic+AngularJS framework stack."},
        
    {id:11 , title:"Workshop: Build a PhoneGap App with Ionic+AngularJS", speaker:"Holly Schinsky", pic: "holly.jpg", time:"3:00pm",
        room:"Theater", twitter_id: "devgirlsfl",
        description: "In this workshop we’ll build a full-blown mobile application from scratch for a real world scenario using PhoneGap and the Ionic+AngularJS framework stack."},
        
    {id:12 , title:"Workshop: Build a PhoneGap App with Ionic+AngularJS", speaker:"Holly Schinsky", pic: "holly.jpg", time:"3:00pm",
        room:"Theater", twitter_id: "devgirlsfl",
        description: "In this workshop we’ll build a full-blown mobile application from scratch for a real world scenario using PhoneGap and the Ionic+AngularJS framework stack."},
        
    {id:13 , title:"Workshop: Build a PhoneGap App with Ionic+AngularJS", speaker:"Holly Schinsky", pic: "holly.jpg", time:"3:00pm",
        room:"Theater", twitter_id: "devgirlsfl",
        description: "In this workshop we’ll build a full-blown mobile application from scratch for a real world scenario using PhoneGap and the Ionic+AngularJS framework stack."}
